...
.vwr-hdr-title { color: #FBCFE8; font-weight: 700; font-size: .88rem; }
.vwr-badge {
...
.vwr-hint { color: #93C5FD; font-size: .73rem; margin-left: auto; }
/* ── Barra de estado ────────────────── */
.vwr-status {
    background: #1E3A8A;
...
/* ── Botones de la cinta ─────────────── */
[data-testid="stDataEditor"] { border: 1.5px solid #D1D5DB !important; border-top:none !important; }
</style>
"""
