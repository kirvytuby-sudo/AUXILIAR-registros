...
# ─────────────────────────────────────────────────────────────────────────────
# PÓLIZA DE NÓMINA — Matriz empleados × semana
# ─────────────────────────────────────────────────────────────────────────────
def generar_poliza_nomina(pagos_excel_path, out_path, plantilla_path=None):
    ...
    pagos_excel_path : ruta al Excel generado por escribir_pagos_bancarios_todo
    out_path         : ruta de salida del Excel generado
    plantilla_path   : reservado (no se usa en esta versión)
    """
    ...
    # ── Leer PagosBancarios ──────────────────────────────────────────────────
    wb_src = Workbook.__class__  # dummy
    import openpyxl as _opxl
    wb_pago = _opxl.load_workbook(pagos_excel_path, data_only=True)
    ...
    C_TBBVA = C_TOT + 2
    C_CONC  = C_TOT + 3
    GL = _opxl.utils.get_column_letter
